...
export default function NFTPageContent() {
  ...
  const { referrerAddress, hasReferrer } = useReferral()
  ...
  const handleMint = () => {
    ...
    // In production: call mint contract function with referrer
    console.log(`Minting ${mintAmount} of NFT ${nft.id}`)
    if (referrerAddress) {
      console.log(`Using referrer: ${referrerAddress}`)
    }
  }
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-brand-primary/70 text-sm">
                Your referrer will earn 20% of mint revenue when you mint this NFT
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-dark-card rounded-xl p-6 space-y-4">
            ...
            <div className="border-t border-dark-border pt-4">
              ...
              {/* Referrer Info in Mint Section */}
              {hasReferrer && (
                <div className="mt-3 p-3 bg-brand-primary/5 border border-brand-primary/10 rounded-lg">
                  <div className="text-brand-primary text-sm">
                    💡 Your referrer will earn 20% when you mint
                  </div>
                </div>
              )}
            </div>
